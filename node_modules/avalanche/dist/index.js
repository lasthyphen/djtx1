...
class Avalanche extends avalanche_1.default {
     ...
     * otherwise default "2abk8oCqF74M1L2UhsPGe1MMXoEkRVubGZxV1Nfn7aF5s5T8fM"
     * @param CChainID Sets the blockchainID for the EVM. Will try to auto-detect,
     * otherwise default "2FXwKL6ioNTtTn7qMVBm3YVRvdEGAJv1e1uaKMF8UzLNuy5caK"
    ...
    constructor(host, port, protocol = "http", networkID = constants_1.DefaultNetworkID, XChainID = undefined, CChainID = undefined, hrp = undefined, skipinit = false) {
        ...
        if (typeof XChainID === "undefined" ||
            !XChainID ||
            XChainID.toLowerCase() === "v") {
            if (networkID.toString() in constants_1.Defaults.network) {
                xchainid = constants_1.Defaults.network[1].V.blockchainID;
            }
            else {
                xchainid = constants_1.Defaults.network[1].V.blockchainID;
            }
        ...
        if (typeof CChainID === "undefined" ||
            !CChainID ||
            CChainID.toLowerCase() === "u") {
            if (networkID.toString() in constants_1.Defaults.network) {
                cchainid = constants_1.Defaults.network[1].U.blockchainID;
            }
            else {
                cchainid = constants_1.Defaults.network[1].U.blockchainID;
            }
        ...
        if (!skipinit) {
            ...
            this.addAPI("xchain", api_3.AVMAPI, "/ext/bc/V", xchainid);
            this.addAPI("cchain", api_4.EVMAPI, "/ext/bc/U/djtx", cchainid);
