...
export declare class PlatformVMAPI extends JRPCAPI {
     ...
     */
    exportDJTX: (username: string, password: string, amount: BN, to: string) => Promise<string | ErrorResponseObject>;
    /**
     * Send DJTX from an account on the P-Chain to an address on the X-Chain. This transaction
     ...
     * by calling issueTx.
     */
    importDJTX: (username: string, password: string, to: string, sourceChain: string) => Promise<string | ErrorResponseObject>;
    /**
