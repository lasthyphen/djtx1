...
class PlatformVMAPI extends jrpcapi_1.JRPCAPI {
     ...
     */
    constructor(core, baseURL = "/ext/bc/M") {
        super(core, baseURL);
        /**
         * @ignore
         */
        ...
        this.getDefaultTxFee = () => {
            return this.core.getNetworkID() in constants_1.Defaults.network
                ? new bn_js_1.default(constants_1.Defaults.network[this.core.getNetworkID()]["M"]["txFee"])
        ...
        this.getCreateSubnetTxFee = () => {
            return this.core.getNetworkID() in constants_1.Defaults.network
                ? new bn_js_1.default(constants_1.Defaults.network[this.core.getNetworkID()]["M"]["createSubnetTx"])
                : new bn_js_1.default(0);
        };
        /**
        ...
        this.getCreateChainTxFee = () => {
            return this.core.getNetworkID() in constants_1.Defaults.network
                ? new bn_js_1.default(constants_1.Defaults.network[this.core.getNetworkID()]["M"]["createChainTx"])
                : new bn_js_1.default(0);
        };
        /**
        ...
        this.getDefaultCreationTxFee = () => {
            return this.core.getNetworkID() in constants_1.Defaults.network
                ? new bn_js_1.default(constants_1.Defaults.network[this.core.getNetworkID()]["M"]["creationTxFee"])
                : new bn_js_1.default(0);
        };
        /**
