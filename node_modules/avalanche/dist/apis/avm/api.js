...
class AVMAPI extends jrpcapi_1.JRPCAPI {
     ...
     * @param baseURL Defaults to the string "/ext/bc/V" as the path to blockchain's baseURL
     * @param blockchainID The Blockchain"s ID. Defaults to an empty string: ""
     */
    constructor(core, baseURL = "/ext/bc/V", blockchainID = "") {
        super(core, baseURL);
        /**
         * @ignore
         */
        ...
        this.refreshBlockchainID = (blockchainID = undefined) => {
            ...
            if (typeof blockchainID === "undefined" &&
                ...
                this.blockchainID = constants_2.Defaults.network[`${netid}`].V.blockchainID; //default to X-Chain
                return true;
            }
        ...
        this.getDefaultTxFee = () => {
            return this.core.getNetworkID() in constants_2.Defaults.network
                ? new bn_js_1.default(constants_2.Defaults.network[this.core.getNetworkID()]["V"]["txFee"])
        ...
        this.getDefaultCreationTxFee = () => {
            return this.core.getNetworkID() in constants_2.Defaults.network
                ? new bn_js_1.default(constants_2.Defaults.network[this.core.getNetworkID()]["V"]["creationTxFee"])
                : new bn_js_1.default(0);
        };
        /**
        ...
        this.getDefaultMintTxFee = () => {
            return this.core.getNetworkID() in constants_2.Defaults.network
                ? new bn_js_1.default(constants_2.Defaults.network[this.core.getNetworkID()]["V"]["mintTxFee"])
                : new bn_js_1.default(0);
        };
        /**
